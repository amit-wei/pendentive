...
Eleven functions, thirty-three requirements and ten risks. Three of the
...
model. Thirty of the thirty-three requirements produced a criterion. `REQ-AD-015`
and `REQ-AD-034` carry a `TBD` by design. `REQ-AD-001` does not, and the criterion
